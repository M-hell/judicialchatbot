...
const Intro = () => {
    ...
    const words = ["Legal Advice", "Court Procedures", "Case Laws", "Rights Protection", "Law Guidance"];
        ...
        >
            ...
            <div className='absolute top-4 right-6 flex space-x-4'>
                <motion.button onClick={() => navigate('/login')}
                    ...
                    className='px-4 py-2 bg-white text-blue-900 font-semibold rounded-lg shadow-md hover:bg-gray-200 transition'>Log In
                </motion.button>
                <motion.button onClick={() => navigate('/signup')}
                    whileHover={{ scale: 1.05 }}
                    transition={{ duration: 0.3, ease: "easeOut" }}
                    className='px-4 py-2 bg-blue-700 text-white font-semibold rounded-lg shadow-md hover:bg-blue-800 transition'>Sign Up
                </motion.button>
            </div>
            ...
            >
                Your personal AI-powered legal assistant, offering expert guidance on various judicial matters. Whether you need help understanding legal processes, seeking court procedures, or protecting your rights, our chatbot provides real-time assistance. Empower yourself with instant responses and stay informed about the law effortlessly!
            </motion.p>
        </motion.div>
    );
}
